                    ...
                    {({ errors, touched }) => (
                        <div className='login mt-5 p-2'>
                            <div className='login-form'>
                                <div className='text-center text-white'><img src={logo} style={{height:"2em"}} alt='new'/></div>
                                <Form>
                                    <div className="form-group">
                                        <label htmlFor="fullName" className='text-white'>Full Name</label>
                                        <Field name="fullName" className="form-control" type="text" placeholder="Enter Name" />
                                    ...
                                    <div className="form-group">
                                        ...
                                        <Field name="mobile" className="form-control" type="text" placeholder="Enter Mobile" />
                                    ...
                                    <div className="form-group pt-2">
                                        ...
                                        {errors.confirmPassword && touched.confirmPassword ? (
                                            <div style={{ color: "yellow" }}>{errors.confirmPassword}</div>
                                        ) : null}
                                    </div>
                                ...
                                <div className='m-2 pt-3'>
                                    <h6 className=' text-white text-center pt-3'>Do you have an account please login !..</h6>

                        ...
                        <div className='login mt-5 p-2'>
                            <div className='login-form'>
                                ...
                                <div className='m-2 pt-3'>
                                    ...
                                    <h6 className=' text-warning text-center'>Forgot Password ?</h6>
                                    <div className='d-flex justify-content-center   '>
                                        <Button variant="outline-light" onClick={() => navigate("/forgot-password")}>
                                            Forgot password
                                        </Button>
                                    </div>

                                    <h6 className=' text-white text-center pt-3'>Don't have an account please sign-up </h6>
